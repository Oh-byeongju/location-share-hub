...
<body>
    <form class="createForm">
        <div class="inputArea">
            ...
            <div class="inputLayout">
                <div class="inputCenter">
                    <input id="groupIdText" class="inputText" placeholder="아이디를 입력해주세요." maxlength="15" autocomplete="off">
                </div>
            </div>
            <button id="groupIdCheckButton" class="inputCheckButton" type="button">
                중복확인
            </button>
        </div>
        ...
        <div class="inputArea">
            ...
            <div class="inputLayout">
                <div class="inputCenter">
                    <input id="groupNmText" class="inputText" placeholder="그룹명을 입력해주세요." maxlength="20" autocomplete="off">
                </div>
            </div>
        </div>
