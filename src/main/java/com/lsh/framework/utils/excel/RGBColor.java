package com.lsh.framework.utils.excel;
...
public class RGBColor {
    int colorCounter = 63;
    Hashtable<String, JxlColour> parsedColors = new Hashtable<String, JxlColour>();

    public JxlColour getColor(String color, WritableWorkbook wb) {
        int[] result;
        ...
        if (!parsedColors.containsKey(color)) {
            ...
            JxlColour col = new JxlColour(colorCounter, "custom", result[0], result[1], result[2]);
